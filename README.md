...
| **SFP ports** | 4× SFP (ports 45-48) | ✅ Confirmed | Symbols `DRV_SFP_*` + stock config |
...
| **Ports SFP** | 4× SFP (ports 45-48) | ✅ Confirmé | Symboles `DRV_SFP_*` + config stock |
